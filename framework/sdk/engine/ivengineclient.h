...
public:
	bool is_console_visible()
	{
		...
		return utilities::call_vfunc<original_fn>(this, 11)(this);
	}

	int get_player_for_user_id(int user_id)
	{
		using original_fn = int(__thiscall*)(PVOID, int);
		return utilities::call_vfunc<original_fn>(this, 9)(this, user_id);
	}
	...
	float time()
	{
		...
		return utilities::call_vfunc<original_fn>(this, 14)(this);
	}
	...
	{
		using original_fn = bool(__thiscall*)(PVOID);
		return utilities::call_vfunc<original_fn>(this, 28)(this);
	}
