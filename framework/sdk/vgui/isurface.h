...
public:
	...
	void draw_set_colour(int r, int g, int b, int a)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, int, int, int, int);
		utilities::call_vfunc<OriginalFn>(this, 11)(this, r, g, b, a);
	}
	...
	void draw_outlined_circle(int x, int y, int radius, int segments) {
		using original_fn = void(__thiscall*)(PVOID, int, int, int, int);
		utilities::call_vfunc<original_fn>(this, 99)(this, x, y, radius, segments);
	}
	...
	void draw_textured_poly_line(vertex_t* vertices, int n)
	{
		using original_fn = void(__thiscall*)(PVOID, vertex_t*, int);
		utilities::call_vfunc<original_fn>(this, 100)(this, vertices, n);
	}
	...
	void set_font_glyph_set(unsigned long& font, const char* windows_font_name, int tall, int weight, int blur, int scanlines, int flags) //scanlines are just literal lines across the font. used in half-life 2 HUD elements
	{
	...
	{
		using original_fn = void(__thiscall*)(PVOID, int, int, int, int, unsigned, unsigned, bool);
		utilities::call_vfunc<original_fn>(this, 118)(this, x0, y0, x1, y1, alpha0, alpha1, horizontal);
	}
};
